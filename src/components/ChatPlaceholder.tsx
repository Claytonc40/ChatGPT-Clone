import IconAlertTriangle from "./icons/iInfo";
import IconLightningBolt from "./icons/iLightning";
import IconSunTwentyFour from "./icons/iSun";

export const ChatPlaceholder = () => {
  return (
    <div className="m-5">
      <h3 className="text-4xl font-bold text-center my-8">Clone-ChatGPT</h3>
